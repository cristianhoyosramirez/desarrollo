  ...
  <div class="page">
    ...
    <div class="container">
      <div class="row gy-2 align-items-center">
        ...
        <div class="col">
          <div class="col-12 col-lg-auto mt-3 mt-lg-0">
            <p class="text-primary h3 ">Lista de clientes con saldo </p>
          </div>
        </div>
        ...
        <div class="container">
          ...
          <div class="row g-2 align-items-end">
            ...
            <div class="col-6 col-sm-4 col-md-2 col-xl-2 py-3">
              ...
              <a href="#" class="btn btn-icon btn-indigo w-100" onclick="abrir_modal_cliente()"> Agregar Cliente </a>
    ...
    <script src="<?= base_url() ?>public/js/clientes/abrir_modal_cliente.js"></script>
    <script src="<?= base_url() ?>public/js/clientes/DataTable.js"></script>
