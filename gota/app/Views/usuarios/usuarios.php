  ...
  <div class="page">
    ...
    <div class="container">
      <div class="row gy-2 align-items-center">
        ...
        <div class="col">
          <div class="col-12 col-lg-auto mt-3 mt-lg-0">
            <p class="text-primary h3 ">Lista de usuarios activos </p>
          </div>
        </div>
        ...
        <div class="container">
          ...
          <div class="row g-2 align-items-end">
            ...
            <div class="col-6 col-sm-4 col-md-2 col-xl-2 py-3">
              ...
              <a href="#" class="btn btn-icon btn-indigo w-100" data-bs-toggle="modal" data-bs-target="#modal_crear_usuario"> Agregar usuario </a>
    ...
    <?= $this->include('usuarios/modal_crear_usuario') ?>
    <?= $this->include('usuarios/modal_crear_tercero') ?>
    ...
    <!-- Propios -->
    <script src="<?= base_url() ?>public/js/usuarios/autoFocusModalCrearUsuario.js"></script>
    <script src="<?= base_url() ?>public/js/usuarios/CrearUsuarios.js"></script>
    <script src="<?= base_url() ?>public/js/usuarios/DataTable.js"></script>
    <script src="<?= base_url() ?>public/js/usuarios/select2_tipo_identificacion.js"></script>
    <script src="<?= base_url() ?>public/js/usuarios/select2_rol.js"></script>
    <script src="<?= base_url() ?>public/js/usuarios/select2_rutas.js"></script>
    <script src="<?= base_url() ?>public/js/usuarios/autocompletar_tercero.js"></script>
    <script src="<?= base_url() ?>public/js/globales/saltar.js"></script>
    <script src="<?= base_url() ?>public/js/globales/resetInput.js"></script>
    <script src="<?= base_url() ?>public/js/usuarios/modal_tercero.js"></script>
