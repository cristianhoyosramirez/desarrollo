...
class Boletas extends BaseController
{
    ...
    public function documento()
    {
        ...
        $json_data = [
            ...
            'cuentas_por_cobrar' => "$ " . number_format($c_x_c[0]['total_por_cobrar'], 0, ",", "."),
            'abonos' => "$ " . number_format($abonos[0]['pagos_recibidos'], 0, ",", "."),
            'saldo_pendiente' => "$ " . number_format($c_x_c[0]['total_por_cobrar'] - $abonos[0]['pagos_recibidos'], 0, ",", "."),
        ];
