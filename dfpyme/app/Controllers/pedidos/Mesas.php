...
class Mesas extends BaseController
{
    public function index()
    {
        ...
        return view('pedidos/mesas', [
            ...
            'mesas' => $mesas,
            'estado' => $estado,
            'nit_cliente_dian' => $cliente_dian['nitcliente'],
            'nombres_cliente' => $cliente_dian['nombrescliente'],
        ]);
    }
    ...
    function agregar_producto()
    {
        ...
        $se_imprime_en_comanda = model('productoModel')->select('se_imprime')->where('id', $id_producto)->first();
        $codigo_categoria = model('productoModel')->select('codigocategoria')->where('id', $id_producto)->first();
        $codigo_interno_producto = model('productoModel')->select('codigointernoproducto')->where('id', $id_producto)->first();
        $valor_unitario = model('productoModel')->select('valorventaproducto')->where('id', $id_producto)->first();
