        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="<?= base_url('devolucion/imprimir_retiro') ?>" method="POST">
                    ...
                    <button type="button" class="btn btn-primary btn-icon" onclick="imprimir_retiro_de_dinero()">
                        Imprimir el comprobante 
                    </button>
                </form>

                <button type="button" class="btn btn-danger btn-icon" onclick="no_imprimir_retiro_de_dinero()">
                    No imprimir 
                </button>
            </div>
        </div>
