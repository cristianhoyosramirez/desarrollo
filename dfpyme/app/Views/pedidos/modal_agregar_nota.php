        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row" id="operaciones">
                    ...
                    <div class="col-2" onclick="adicionar_nota()">
                    ...
                    <div class="col-2" onclick="descuento()">
                        <label class="form-selectgroup-item">
                            <input type="radio" name="icons" value="home" class="form-selectgroup-input">
                            <span class="form-selectgroup-label">
                ...
                <div class="container" id="nota" style="display:none">
                    ...
                    <div class="row">
                        ...
                        <div class="col-2 tex-end">
                            <div class="row">
                                <div class="col-6"><button type="button" class="btn btn-success" onclick="actualizar_nota()">Guardar </button></div>
                                <div class="col-6"><button type="button" class="btn btn-danger" onclick="cerrar_modal()">Cancelar </button></div>
                            </div>
