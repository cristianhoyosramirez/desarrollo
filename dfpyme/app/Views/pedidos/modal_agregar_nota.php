        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="container" id="nota" style="display:none">
                    ...
                    <div class="row">
                        <div class="col-md-5 d-none d-md-none"></div>
                        <div class="col-12 col-md-6">
                            <button type="button" class="btn btn-outline-success btn-block" onclick="actualizar_nota()">Guardar</button>
                        </div>
                        <div class="col-12 col-md-6">
                            <button type="button" class="btn btn-outline-danger btn-block" onclick="cerrar_modal()">Cancelar</button>
                        </div>
                    </div>
