    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            <div class="row row-deck row-cards">
                ...
                <!--Pedido-->
                <div class="col-md-8" id="productos" style="display: block">
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-icon"  data-bs-toggle="modal" data-bs-target="#exampleModal">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="table-responsive">
                   ...
                   <!--Productos-->
                   <div class="col-md-12" id="pedido" style="display: block">
                    <div class="card" style="height: calc(<?php echo $alturaCalc; ?>)">
