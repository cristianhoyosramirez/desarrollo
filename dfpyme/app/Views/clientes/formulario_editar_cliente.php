...
<form class="row g-3" id="creacion_cliente_electronico" method="POST" action="<?php echo base_url() ?>/clientes/agregar">
    ...
    <div class="col-md-3">
        ...
        <input type="text" class="form-control" id="nombres" name="nombres" onkeyup="saltar_factura_pos(event,'apellidos')" value="<?php  echo  $datos_cliente['nombrescliente'] ?>">
    ...
    <div class="col-md-3">
        ...
        <select class="form-select" name="municipios" id="confirmar_municipios">
