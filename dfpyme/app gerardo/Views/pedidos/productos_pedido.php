                ...
                <tr onclick="agregar_nota(<?php echo $detalle['id'] ?>)">
                    ...
                    <td >
                        ...
                        <div class="input-group">
                            <a href="#" class="btn bg-muted-lt w-1 btn-icon " onclick="eliminar_cantidades(event,'<?php echo $detalle['id_tabla_producto'] ?>')">
                            ...
                            <input   type="number" class="w-3 form-control form-control-sm text-center" value="<?php echo $detalle['cantidad_producto'] ?>"  onclick="detener_propagacion(event)" onkeypress="return valideKey(event)" min="1" max="100" onkeyup="actualizar_producto_cantidad(event,this.value,<?php echo $detalle['id_tabla_producto'] ?>)" readonly >

                            <a href="#" class="btn bg-muted-lt w-1 btn-icon " onclick="actualizar_cantidades(event,'<?php echo $detalle['id_tabla_producto'] ?>')" title="Agregar producto">
