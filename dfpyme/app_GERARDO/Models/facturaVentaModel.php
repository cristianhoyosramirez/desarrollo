...
class facturaVentaModel extends Model
{
    ...
    function registro_inicial($fecha_inicial, $fecha_final)
    {
        ...
        $datos = $this->db->query("
        SELECT
        numerofactura_venta AS regitro_inicial
      FROM
        factura_venta
      WHERE
        id = (SELECT Min(id) AS regitro_inicial FROM factura_venta WHERE fecha_y_hora_factura_venta BETWEEN '$fecha_inicial' AND '$fecha_final' )
    ...
    function registro_final($fecha_inicial, $fecha_final)
    {
        ...
        $datos = $this->db->query("
        SELECT
        numerofactura_venta as regitro_final 
      FROM
        factura_venta
      WHERE
        id = (SELECT max(id) AS regitro_inicial FROM factura_venta WHERE fecha_y_hora_factura_venta BETWEEN '$fecha_inicial' AND '$fecha_final' )
    ...
    public function venta_contado($fecha_inicial, $fecha_final)
    {
        ...
        select
            SUM(total) total_ventas_contado
        FROM
            producto_factura_venta
        WHERE
