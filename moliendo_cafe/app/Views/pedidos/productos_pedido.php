                ...
                <tr onclick="agregar_nota(<?php echo $detalle['id'] ?>,event)">
                    ...
                    <td>
                        ...
                        <div class="input-group-append">
                            ...
                            <input type="number" class="w-5 form-control form-control-sm text-center custom-width" value="<?php echo $detalle['cantidad_producto'] ?>" onclick="detener_propagacion(event),abrir_modal_editar_cantidad(<?php echo $detalle['id_tabla_producto'] ?>)" onkeypress="return valideKey(event)" min="1" max="100"   >
